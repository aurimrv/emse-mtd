...
{ 
int i, count = 0; ponta_de_prova (8949, 1);
    for ( i = 0; ponta_de_prova (8949, 2), i < size; ponta_de_prova (8949, 3), i++  )
        { 
            if  ( ponta_de_prova (8949, 4), (arr[i] == 0) )
                { 
                    ponta_de_prova (8949, 5);
                    count++; 
                } ponta_de_prova (8949, 6);
        } 
    ponta_de_prova (8949, 7);
    return count; ponta_de_prova (8949, 8);
} 
int inArr[20]; 
void main (int argc, char* argv[]) 
{ 
int i, size; ponta_de_prova (9138, 1);
    if (argc <= 1) 
        { 
            ponta_de_prova (9138, 2);
            printf ("Usage: java numZero v1 [v2] [v3] ... \n"); 
            return; ponta_de_prova (9138, 3);
        } 
    ponta_de_prova (9138, 4);
    size = argc - 1; 
    for ( i = 0; ponta_de_prova (9138, 5), i < size; ponta_de_prova (9138, 6), i++  )
        { 
            ponta_de_prova (9138, 7);
            inArr[i] = atoi(argv[i+1]); 
        } 
    ponta_de_prova (9138, 8);
    printf("Number of zeros is: %d\n", numZero (inArr,size)); ponta_de_prova (9138, 9);
} 
