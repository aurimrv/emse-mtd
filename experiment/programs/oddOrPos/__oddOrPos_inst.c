...
int i; ponta_de_prova (8949, 1);
    for ( i = 0; ponta_de_prova (8949, 2), i < length; ponta_de_prova (8949, 3), i++  )
        { 
            if  ( ponta_de_prova (8949, 4), (x[i] % 2 == 1 || x[i] % 2 == -1 || x[i] > 0) )
                { 
...
{ 
int i; ponta_de_prova (9156, 1);
    for ( i = 1; ponta_de_prova (9156, 2), i < argc; ponta_de_prova (9156, 3), i++  )
        { 
            ponta_de_prova (9156, 4);
            inArr[i - 1] = atoi(argv[i]); 
        } 
    ponta_de_prova (9156, 5);
    printf("Number of elements that are either odd or positive is: %d\n", oddOrPos (inArr, argc - 1)); 
    return 0; ponta_de_prova (9156, 6);
} 
