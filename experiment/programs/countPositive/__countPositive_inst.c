...
{ 
int i; ponta_de_prova (9147, 1);
    for ( i = 1; ponta_de_prova (9147, 2), i < argc; ponta_de_prova (9147, 3), i++  )
        { 
            ponta_de_prova (9147, 4);
            inArr[i - 1] = atoi(argv[i]); 
        } 
    ponta_de_prova (9147, 5);
    printf("Number of positive numbers is: %d\n", countPositive(inArr, argc - 1)); 
    return 0; ponta_de_prova (9147, 6);
} 
