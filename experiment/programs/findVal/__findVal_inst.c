...
int i; ponta_de_prova (8949, 1);
    for ( i = 0; ponta_de_prova (8949, 2), i < length; ponta_de_prova (8949, 3), i++  ){
        if  ( ponta_de_prova (8949, 4), (numbers[i] == val) ){
            ponta_de_prova (8949, 5);
            findVal = i; }}
    ponta_de_prova (8949, 7);
    return findVal; ponta_de_prova (8949, 8);
} 
int inArr[100]; 
int main(int argc, char* argv[]) 
{ 
int i, integer; ponta_de_prova (9132, 1);
    integer = atoi(argv[1]); 
    for ( i = 2; ponta_de_prova (9132, 2), i < argc; ponta_de_prova (9132, 3), i++  )
        { 
            ponta_de_prova (9132, 4);
            inArr[i - 2] = atoi(argv[i]); 
        } 
    ponta_de_prova (9132, 5);
    printf("The LAST occurrence of %d is: %d\n", integer, findVal(inArr, argc - 2, integer)); 
    return 0; ponta_de_prova (9132, 6);
} 
