...
{ 
int rslt, i; ponta_de_prova (8949, 1);
    rslt = left; 
    if (right == 0) 
        { 
        ...
        { 
            for ( ponta_de_prova (8949, 3), i = 2; ponta_de_prova (8949, 4), i <= right; ponta_de_prova (8949, 5), i++  ){
                ponta_de_prova (8949, 6);
                rslt = rslt * left; }ponta_de_prova (8949, 7);
        } 
    ponta_de_prova (8949, 8);
    return rslt; ponta_de_prova (8949, 9);
} 
int main (int argc, char* argv[]) 
{ 
int k,l; ponta_de_prova (9142, 1);
    k = atoi(argv[1]); 
    l = atoi(argv[2]); 
    printf("The result is: %d\n", power(k,l)); 
    return 0; ponta_de_prova (9142, 2);
} 
