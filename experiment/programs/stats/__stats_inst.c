...
int i; ponta_de_prova (29598, 1);
    sum = 0.0; 
    for ( i = 0; ponta_de_prova (29598, 2), i < size; ponta_de_prova (29598, 3), i++  )
        { 
            ponta_de_prova (29598, 4);
            sum += numbers[i]; 
        } 
    ponta_de_prova (29598, 5);
    med = numbers[size/2]; 
    mean = sum / size; 
    varsum = 0.0; 
    for ( i = 0; ponta_de_prova (29598, 6), i < size; ponta_de_prova (29598, 7), i++  )
        { 
            ponta_de_prova (29598, 8);
            varsum = varsum + ((numbers[i] - mean) * (numbers [i] - mean)); 
        } 
    ponta_de_prova (29598, 9);
...
{ 
int i; ponta_de_prova (30181, 1);
    for ( i = 1; ponta_de_prova (30181, 2), i < argc; ponta_de_prova (30181, 3), i++  ){
        ponta_de_prova (30181, 4);
        numbers[i-1] = atoi(argv[i]); }
    ponta_de_prova (30181, 5);
    computeStats(numbers, argc-1); 
    printf("\n"); 
    return 0; ponta_de_prova (30181, 6);
} 
