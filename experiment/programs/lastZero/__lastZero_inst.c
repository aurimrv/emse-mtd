...
{ 
int i; 
int index = -1; ponta_de_prova (8949, 1);
    for ( i = 0; ponta_de_prova (8949, 2), i < length; ponta_de_prova (8949, 3), i++  )
        { 
            if  ( ponta_de_prova (8949, 4), (x[i] == 0) )
                { 
    ...
    return index; ponta_de_prova (8949, 8);
} 
int inArr[100]; 
int main(int argc, char* argv[]) 
{ 
int i; ponta_de_prova (9115, 1);
    for ( i = 1; ponta_de_prova (9115, 2), i < argc; ponta_de_prova (9115, 3), i++  )
        { 
            ponta_de_prova (9115, 4);
            inArr[i - 1] = atoi(argv[i]); 
        } 
    ponta_de_prova (9115, 5);
    printf("The last index of zero is: %d\n", lastZero(inArr, argc - 1)); 
    return 0; ponta_de_prova (9115, 6);
} 
