...
int ALIM () 
{ ponta_de_prova (21353, 1);
    return Positive_RA_Alt_Thresh[Alt_Layer_Value]; ponta_de_prova (21353, 2);
} 
int Inhibit_Biased_Climb () 
{ ponta_de_prova (21418, 1);
    return (Climb_Inhibit ? Up_Separation + 100 : Up_Separation); ponta_de_prova (21418, 2);
} 
bool Non_Crossing_Biased_Climb() 
{ 
int upward_preferred; 
int upward_crossing_situation; 
bool result; ponta_de_prova (21517, 1);
    upward_preferred = Inhibit_Biased_Climb() > Down_Separation; 
    if (upward_preferred) 
        { 
            ponta_de_prova (21517, 2);
            result = !(Own_Below_Threat()) || ((Own_Below_Threat()) && (!(Down_Separation >= ALIM()))); 
        } 
    else 
        { 
            ponta_de_prova (21517, 3);
            result = Own_Above_Threat() && (Cur_Vertical_Sep >= 300) && (Up_Separation >= ALIM()); 
        } 
    ponta_de_prova (21517, 4);
    return result; ponta_de_prova (21517, 5);
} 
bool Non_Crossing_Biased_Descend() 
{ 
int upward_preferred; 
int upward_crossing_situation; 
bool result; ponta_de_prova (21956, 1);
    upward_preferred = Inhibit_Biased_Climb() > Down_Separation; 
    if (upward_preferred) 
        { 
            ponta_de_prova (21956, 2);
            result = Own_Below_Threat() && (Cur_Vertical_Sep >= 300) && (Down_Separation >= ALIM()); 
        } 
    else 
        { 
            ponta_de_prova (21956, 3);
            result = !(Own_Above_Threat()) || ((Own_Above_Threat()) && (Up_Separation >= ALIM())); 
        } 
    ponta_de_prova (21956, 4);
    return result; ponta_de_prova (21956, 5);
} 
bool Own_Below_Threat() 
{ ponta_de_prova (22394, 1);
    return (Own_Tracked_Alt < Other_Tracked_Alt); ponta_de_prova (22394, 2);
} 
bool Own_Above_Threat() 
{ ponta_de_prova (22472, 1);
    return (Other_Tracked_Alt < Own_Tracked_Alt); ponta_de_prova (22472, 2);
} 
int alt_sep_test() 
{ 
bool enabled, tcas_equipped, intent_not_known; 
bool need_upward_RA, need_downward_RA; 
int alt_sep; ponta_de_prova (22549, 1);
    ...
    if (enabled && ((tcas_equipped && intent_not_known) || !tcas_equipped)) 
        { 
            ponta_de_prova (22549, 2);
            need_upward_RA = Non_Crossing_Biased_Climb() && Own_Below_Threat(); 
            need_downward_RA = Non_Crossing_Biased_Descend() && Own_Above_Threat(); 
            if (need_upward_RA && need_downward_RA) {
                ponta_de_prova (22549, 3);
                alt_sep = 0; }
            else {
                if  ( ponta_de_prova (22549, 4), (need_upward_RA) ){
                    ponta_de_prova (22549, 5);
                    alt_sep = 1; }
                else {
                    if  ( ponta_de_prova (22549, 6), (need_downward_RA) ){
                        ponta_de_prova (22549, 7);
                        alt_sep = 2; }
                    else {
                        ponta_de_prova (22549, 8);
                        alt_sep = 0; }}}ponta_de_prova (22549, 11);
        } 
    ponta_de_prova (22549, 12);
    return alt_sep; ponta_de_prova (22549, 13);
} 
main(argc, argv) 
int argc; 
char *argv[]; 
{ ponta_de_prova (23323, 1);
    if (argc < 13) 
        { 
            ponta_de_prova (23323, 2);
