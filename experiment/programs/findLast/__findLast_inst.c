...
{ 
int i; ponta_de_prova (8949, 1);
    for ( i = size -1; ponta_de_prova (8949, 2), i >= 0; ponta_de_prova (8949, 3), i--  )
        { 
            if  ( ponta_de_prova (8949, 4), (x[i] == y) )
                { 
                    ponta_de_prova (8949, 5);
                    return i; ponta_de_prova (8949, 6);
                } ponta_de_prova (8949, 7);
        } 
    ponta_de_prova (8949, 8);
    return -1; ponta_de_prova (8949, 9);
} 
int inArr[20]; 
void main (int argc, char* argv[]) 
{ 
int i, size, integer; ponta_de_prova (9133, 1);
    if (argc <= 2) 
        { 
            ponta_de_prova (9133, 2);
            printf ("Usage: findLast integer v1 [v2] [v3] ... \n"); 
            return; ponta_de_prova (9133, 3);
        } 
    ponta_de_prova (9133, 4);
    size = argc - 2; 
    integer = atoi(argv[1]); 
    for ( i = 0; ponta_de_prova (9133, 5), i < size; ponta_de_prova (9133, 6), i++  )
        { 
            ponta_de_prova (9133, 7);
            inArr[i] = atoi(argv[i+2]); 
        } 
    ponta_de_prova (9133, 8);
    printf("The index of the last element equals %d is %d\n", integer, findLast (inArr, integer, size)); ponta_de_prova (9133, 9);
} 
