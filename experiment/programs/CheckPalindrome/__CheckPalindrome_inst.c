...
{ 
int low = 0; 
int high = strlen(s)-1; ponta_de_prova (12702, 1);
    
    while  ( ponta_de_prova (12702, 2), (low < high) )
        { 
            if  ( ponta_de_prova (12702, 3), (s[low] != s[high]) ){
                ponta_de_prova (12702, 4);
                return 0; }
            ponta_de_prova (12702, 5);
            low++; 
            high--; 
        } 
    ponta_de_prova (12702, 6);
    return 1; ponta_de_prova (12702, 7);
} 
void main(int argc, char *argv[]) 
{ 
char *p = argv[1]; ponta_de_prova (12900, 1);
    if (isPalindrome(p)) {
        ponta_de_prova (12900, 2);
        printf("%s is a palindrome",p); }
    else {
        ponta_de_prova (12900, 3);
        printf("%s is not a palindrome",p); }ponta_de_prova (12900, 4);
} 
