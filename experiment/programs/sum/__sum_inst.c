...
int i; ponta_de_prova (8949, 1);
    ...
    return s; ponta_de_prova (8949, 6);
} 
int inArr[100]; 
int main (int argc, char* argv[]) 
{ 
int i; ponta_de_prova (9076, 1);
    for ( i = 1; ponta_de_prova (9076, 2), i < argc; ponta_de_prova (9076, 3), i++  )
        { 
            ponta_de_prova (9076, 4);
            inArr[i - 1] = atoi(argv[i]); 
        } 
    ponta_de_prova (9076, 5);
    printf("The result is: %d\n", sum(inArr, argc - 1)); 
    return 0; ponta_de_prova (9076, 6);
} 
