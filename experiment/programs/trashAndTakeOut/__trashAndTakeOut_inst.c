...
void trash (int x) 
{ 
int m, n, o; ponta_de_prova (8950, 1);
    m = 0; 
    if (x > 0) {
        ponta_de_prova (8950, 2);
        m = 4; }
    if  ( ponta_de_prova (8950, 3), (x > 5) ){
        ponta_de_prova (8950, 4);
        n = 3 * m; }
    else {
        ponta_de_prova (8950, 5);
        n = 4 * m; }
...
{ 
int d, e; ponta_de_prova (9131, 1);
    d = 42 * a; 
    if (a > 0) {
        ponta_de_prova (9131, 2);
        e = 2 * b + d; }
    else {
        ponta_de_prova (9131, 3);
        e = b + d; }
    ponta_de_prova (9131, 4);
    return e; ponta_de_prova (9131, 5);
} 
main(argc, argv) 
int argc; 
char *argv[]; 
{ ponta_de_prova (9259, 1);
    if ( strcmp("-", argv[1]) == 0 ) 
        { 
            ponta_de_prova (9259, 2);
            driver(atoi(argv[2]), argc, argv); 
        } 
    else 
        { 
            ponta_de_prova (9259, 3);
            driver(0, argc, argv); 
        } 
    ponta_de_prova (9259, 4);
    return 0; ponta_de_prova (9259, 5);
} 
